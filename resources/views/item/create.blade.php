                    ...
                    <div class="card-body">
                        <form action="{{route('item.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name')}}" class="mt-2 form-control">
                            </div>
                            @error("name")
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" value="{{old('price')}}" class="mt-2 form-control">
                            </div>
                            @error("price")
                            <small class="d-block font-weight-bold text-danger">{{ $message }}</small>
                            @enderror
                            ...
                            <button class="btn btn-outline-primary mt-2">Add Item</button>
                        </form>
                    </div>
                </div>
            </div>
